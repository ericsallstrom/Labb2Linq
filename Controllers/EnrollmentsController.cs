...
namespace Labb2Linq.Controllers
{
    public class EnrollmentsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("EnrollmentId,FkStudentId,FkCourseId,Grade")] Enrollment enrollment)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("EnrollmentId,FkStudentId,FkCourseId,Grade")] Enrollment enrollment)
        {
